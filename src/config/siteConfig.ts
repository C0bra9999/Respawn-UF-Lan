...
export const eventInfo = {
   ...
   maxParticipants: 100, // Totalt antal platser
   currentParticipants: 17, // Uppdateras automatiskt från registreringar
...
export const infoSection = {
   ...
   features: [
      ...
      },
      {
         ...
         description: "Tävla i CS2, Marvel Rivals, Valorant och Clash Royal",
         color: "text-blue-400",
      ...
      },
      {
         icon: "Pizza",
         title: "Mat & dryck",
         description: "Pizza, snacks och energidryck finns att köpa på plats",
...
export const tournamentsSection = {
   ...
   title: "Turneringar",
   titleHighlight: ".",
   description: "Tävla i dina favoritspel och vinn fantastiska priser!",
   ...
   tournaments: [
      {
         ...
         description: "Klassisk Wingman 2v2 tävling med best-of-3 playoff",
         features: [
...
export const registrationSection = {
   ...
   messages: {
      ...
      successWithPopup: "Anmälan mottagen! Discord-servern öppnas nu...",
      successDescription: "Välkommen till Respawn UF LAN 2025! 🎮",
      successWithBlockedPopup: "Anmälan mottagen!",
      successBlockedDescription: "Klicka här för att gå med i Discord-servern",
      discordButtonLabel: "Öppna Discord",
      error: "Ett fel uppstod. Försök igen eller kontakta oss på respawnuf@gmail.com",
   },
};
...
export const contactSection = {
   ...
   title: "Kontakta",
   titleHighlight: "oss",
   description: "Har du frågor? Vi finns här för att hjälpa dig!",
...
export const footer = {
   ...
   copyright: "© 2025 Respawn UF LAN – Alla rättigheter reserverade.",
   bottomLinks: [
