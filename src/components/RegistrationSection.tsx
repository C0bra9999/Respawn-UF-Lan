...
import { Send, User, Mail, MessageSquare, CreditCard } from "lucide-react";
...
export function RegistrationSection() {
   ...
   const handleTournamentToggle = (tournamentId: string) => {
      setFormData((prev) => ({
         ...prev,
         selectedTournaments: prev.selectedTournaments.includes(tournamentId)
   ...
   const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
         ...
         const tournamentNames = formData.selectedTournaments
            .map(
               (id) =>
                  registrationSection.tournamentOptions.find((t) => t.id === id)
                     ?.name || id
            )
            .join(", ");
         ...
         if (
            !discordWindow ||
            discordWindow.closed ||
            typeof discordWindow.closed === "undefined"
         ) {
            ...
            toast.success(
               ...
               {
                  description:
                     registrationSection.messages.successBlockedDescription,
                  action: {
                     label: registrationSection.messages.discordButtonLabel,
                     onClick: () =>
                        window.open(eventInfo.discordInviteUrl, "_blank"),
                  },
                  duration: 10000,
               }
            );
            ...
            toast.success(registrationSection.messages.successWithPopup, {
            ...
            >
               ...
               >
                  ...
                  <span className="text-green-400">
                     {registrationSection.titleHighlight}
                  </span>
               </h2>
               ...
               <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                     ...
                     <Input
                        ...
                        className="bg-gray-900/50 border-gray-600 text-white focus:border-green-400"
                        placeholder={
                           registrationSection.form.discordPlaceholder
                        }
                        required
                     />
                  </div>
                  ...
                  <div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {registrationSection.tournamentOptions.map(
                           (tournament) => (
                              <div
                                 key={tournament.id}
                     ...
                     <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm">
                           <p className="text-blue-300 mb-1">
                              <strong>
                                 {registrationSection.discordInfo.title}
                              </strong>
                           </p>
