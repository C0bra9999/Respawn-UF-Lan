...
const CountdownTimer = memo(({ timeLeft }: { timeLeft: { days: number; hours: number; minutes: number; seconds: number } }) => {
  const items = useMemo(() => [
    ...
    { value: timeLeft.minutes, label: heroSection.countdownLabels.minutes },
    { value: timeLeft.seconds, label: heroSection.countdownLabels.seconds },
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div>
            ...
            >
              {heroSection.title}<span className="text-green-400">{heroSection.titleHighlight}</span>{" "}
